...
class SubCrawlerTestCase(unittest.TestCase):
    def test_presence_youtube_video_in_itself(self):
        self.assertTrue(has_video_url("https://www.youtube.com/watch?v=mlzrhbpmyai"))

    def test_presence_another_video(self):
        self.assertTrue(has_video_url("https://www.youtube.com/watch?v=ltksvh05huy"))

    def test_presence_twitch_video(self):
        self.assertTrue(has_video_url("http://www.twitch.tv/esl_lol/v/30574431?t=5h09m40s   "))
